...
import { QUOTES_AVAILABLE, ADD_QUOTE, UPDATE_QUOTE, DELETE_QUOTE } from "../actions/types" //Import the actions types constant we defined in our actions

let initialState = { quotes: [], loading:true };
